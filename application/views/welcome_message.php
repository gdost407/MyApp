            ...
            <form action="" method="post" autocomplete="off" id="cdForm">
                    <div class="row">
                        ...
                        <div class="col-6 mb-2">
                            ...
                            <input type="text" name="cdAmount" id="cdAmount" class="form-control form-control-sm" placeholder="Amount..." required>
                        </div>
                        <div class="col-12 mb-2">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="me-3">
                            ...
                            <div class="text-lg fw-bold">&#8377; <?php echo $month_credit-$month_debit;?></div>
                        </div>
